...
// changed ports
// Top Right: 4, Green (2chnage to 4)
// Bottom Right: -2 (Back), -5 (Front), Blue
pros::Motor right_motor1(7, pros::v5::MotorGears::blue, pros::v5::MotorUnits::degrees);
pros::Motor right_motor2(-4, pros::v5::MotorGears::blue, pros::v5::MotorUnits::degrees);    
...
// Lift: -17 (17 to 13), Red, !Because FWD is down!
//arm goes up at start of match
pros::Motor intake(-15, pros::v5::MotorGears::green, pros::v5::MotorUnits::degrees);
pros::Motor lift(-13, pros::v5::MotorGears::red, pros::v5::MotorUnits::degrees);
...
// Switchblade
pros::adi::Pneumatics switchBlade1('f', true);  
pros::adi::Pneumatics switchBlade2('g', false);  
